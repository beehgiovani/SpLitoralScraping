...
if m:
    ...
    url_aviso = f"https://egov.santos.sp.gov.br/tribusweb/Geral/BoletoAvisoObrigacao/Principal/1/2026/{id_lanc}/4/06/04/2026/{inscricao}"
    s.get(url_aviso)
    ...
    print(r_pdf.status_code)
    print(r_pdf.content[:50])
else:
    print("No ID found")
